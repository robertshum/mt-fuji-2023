...
// Original file from sample:
// https://github.com/needle-tools/needle-engine-samples/blob/main/package/Runtime/PostProcessing/Needle.Samples.PostProcessing~/FocusDistancer.ts
