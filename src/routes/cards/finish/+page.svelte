<script>
  ...
  import img1 from "$lib/images/finish/1.jpg";
</script>

<TransitionCardWrapper>
  <article class="card-info">
    <h1 class="card-title">Finishing the Journey 🏁</h1>
    <CardStat time="5:45pm" elevation="2300m" weather="rainy" />
    <p>
    ...
    <ul class="list-disc mt-1 mb-5">
      ...
      <li class="ml-4">
        The summit temperature was roughly <strong>0-5C</strong>, felt colder
        with the wind.
      </li>
    </ul>
  </article>
