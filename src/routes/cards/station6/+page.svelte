<script>
  ...
  import img1 from "$lib/images/station6/1.png";
  import img2 from "$lib/images/station6/2.png";
  import img3 from "$lib/images/station6/3.png";
  import img4 from "$lib/images/station6/4.jpg";
</script>
